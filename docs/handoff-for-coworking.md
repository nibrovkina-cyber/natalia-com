# Handoff для коворка — как работать с natalia.com

Документ-передача: всё, что нужно знать чтобы продолжать дизайн **natalia.com** в том же визуальном языке и не терять качество.

---

## 📦 Что уже собрано

**natalia.com** — Next.js 16 / React 19 / TypeScript сайт AI-маркетинг студии Натальи Бровкиной с 16 AI-агентами на методологии Ogilvy / Schwartz / Hopkins.
