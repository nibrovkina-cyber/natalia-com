...
const TIERS = [
  ...
  },
  {
    ...
    priceValue: "2 990",
    priceUnit: "₽ / месяц",
    billing: <><b>7 дней trial</b> · без карты · отмена в один клик</>,
    features: [
    ...
    ctaLabel: "Начать 7-дневный trial →",
    ctaHref: "/tool",
    ctaVariant: "primary" as const,
    ctaExternal: false,
    fineprint: "Без карты сейчас. Спросим только когда триал закончится — за день предупредим.",
    featured: true,
  },
  {
    roman: "III — СО МНОЙ",
